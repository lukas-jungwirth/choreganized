...
Extend these rather than forking a variant; look at them side by side at **`/dev/kit`**
(dev-only gallery, → [DECISIONS #39](DECISIONS.md)) and add to it when you add a component.
